        ...
        <div class="portlet light ">
            ...
            <div class="portlet-title">
                ...
                <div class="actions">
                    <div style="float:right;">
                        ...
                        <a target="_blank" href="<?=site_url('login/reminder')?>" class="btn btn-sm btn-circle btn-success" data-placement="top" data-container="body"><i class="fa fa-history"></i> Run Reminder</a>
            ...
            <div class="portlet-body">
                ...
                <div class="table-container">
                    ...
                    <table class="table table-striped table-bordered table-hover table-wrap" id="table_reminder">
                        <thead>
                            ...
                            <tr role="row" class="filter display-hide">
                                ...
                                <td><input name="reminder_name" tipe="1" a1="text-center" class="form-control form-filter input-md" placeholder="search" type="text" autocomplete="off"></td>
                                <td><input name="reminder_date" tipe="1" a1="text-center" class="form-control form-filter input-md" placeholder="search" type="text" autocomplete="off"></td>
                                <td><input name="description" tipe="1"  a2="false" a1="text-center" class="form-control form-filter input-md" placeholder="search" type="text" autocomplete="off"></td>
...
$(document).ready(function() {
    ...
    //================================= Datatable ==========================================
        //variabel
        var table_name  = "table_reminder";
        var url         = "<?=site_url($url);?>/table_reminder";
        var sort        = [-1,0];
        var order       = [];
        //column order
        var header = [];
        ...
        //table init
        table_reminder.initDefault(url, header, order, sort);
    ...
    //=============================== FILERING =========================================
        //date
        $(".table_reminder .tanggal").datepicker({
             rtl: Metronic.isRTL(), orientation: "left", autoclose: true, format : 'yyyy-mm-dd',
        });

        //select2 biasa
        $(".table_reminder .select2_biasa").select2({
    ...
    //=============================== Action =========================================
        ...
        //load add
        $('.table_reminder').on('click', '.btn_add', function(e) {
            $('#popup_add').modal();
            var id = $(this).attr('id');
        ...
        //load edit
        $('.table_reminder').on('click', '.btn_edit', function(e) {
            $('#popup_edit').modal();
            var id = $(this).attr('id');
        ...
        //btn delete
        $('.table_reminder').on('click', '.btn_delete', function(e) {
            var id = $(this).attr('id');
