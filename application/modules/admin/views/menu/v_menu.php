        ...
        <div class="portlet light ">
            ...
            <div class="portlet-body">
                ...
                <div class="table-container">
                    ...
                    <table class="table table-striped table-bordered table-hover table-wrap" id="table_menu">
                        <thead>
                            ...
                            <tr role="row" class="filter display-hide">
                                ...
                                <td><input name="parent" tipe="2" a1="text-center" class="form-control form-filter input-md" placeholder="search" type="text" autocomplete="off"></td>
                                <td><input name="order" tipe="2" a1="text-center" class="form-control form-filter input-md" placeholder="search" type="text" autocomplete="off"></td>
                                ...
                                <td><input name="folder" tipe="1" a1="text-center" class="form-control form-filter input-md" placeholder="search" type="text" autocomplete="off"></td>
                                <td><input name="controler" tipe="1" a1="text-center" class="form-control form-filter input-md" placeholder="search" type="text" autocomplete="off"></td>
                                <td><input name="link" tipe="1" a1="text-center" class="form-control form-filter input-md" placeholder="search" type="text" autocomplete="off"></td>
...
$(document).ready(function() {
    ...
    //================================= Datatable ==========================================
        //variabel
        var table_name  = "table_menu";
        var url         = "<?=site_url($url);?>/table_menu";
        var sort        = [-1,0];
        var order       = [];
        //column order
        var header = [];
        ...
        //table init
        table_menu.initDefault(url, header, order, sort);
    ...
    //=============================== Action =========================================
        ...
        //load add
        $('.table_menu').on('click', '.btn_add', function(e) {
            $('#popup_add').modal();
            var id = $(this).attr('id');
        ...
        //load edit
        $('.table_menu').on('click', '.btn_edit', function(e) {
            $('#popup_edit').modal();
            var id = $(this).attr('id');
        ...
        //btn delete
        $('.table_menu').on('click', '.btn_delete', function(e) {
            var id = $(this).attr('id');
