                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input name="name" type="text" class="form-control required" placeholder="Nama Role" value="<?php echo $data->ROLE_NAME ?>"/>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="portlet box grey">
                                                <div class="portlet-title">
                                                    ...
                                                    <div class="tools"><input name="chk[]" class="chk_semua" type="checkbox" value="<?php echo $row->MENU_ID;?>" <?=checked_data($arr_menu, $row->MENU_ID)?> /></div>
                                                </div>
                                                    ...
                                                    <div class="portlet-body">
                                                        <table class="table table-bordered group">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="10px"><input type="checkbox" class="chk_sub" name="chk[]" value="<?php echo $row2->MENU_ID;?>" <?=checked_data($arr_menu, $row2->MENU_ID)?> /></td>
                                                            </tr>
                                                            <?php endforeach?>
                                                        </table>
                                                    </div>
