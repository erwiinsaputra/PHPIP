        ...
        <div class="portlet light ">
            ...
            <div class="portlet-body">
                ...
                <div class="table-container">
                    ...
                    <table class="table table-striped table-bordered table-hover table-wrap" id="table_bsc_type">
                        <thead>
...
$(document).ready(function() {
    ...
    //================================= Datatable ==========================================
        //variabel
        var table_name  = "table_bsc_type";
        var url         = "<?=site_url($url);?>/table_bsc_type";
        var sort        = [-1,0];
        var order       = [];
        //column order
        var header = [];
        ...
        //table init
        table_bsc_type.initDefault(url, header, order, sort);
    ...
    //=============================== FILERING =========================================
        //date
        $(".table_bsc_type .tanggal").datepicker({
             rtl: Metronic.isRTL(), orientation: "left", autoclose: true, format : 'yyyy-mm-dd',
        });

        //select2 biasa
        $(".table_bsc_type .select2_biasa").select2({
    ...
    //=============================== Action =========================================
        ...
        //load add
        $('.table_bsc_type').on('click', '.btn_add', function(e) {
            $('#popup_add').modal();
            var id = $(this).attr('id');
        ...
        //load edit
        $('.table_bsc_type').on('click', '.btn_edit', function(e) {
            $('#popup_edit').modal();
            var id = $(this).attr('id');
        ...
        //btn non_active
        $('.table_bsc_type').on('click', '.btn_delete', function(e) {
            var id = $(this).attr('id');
