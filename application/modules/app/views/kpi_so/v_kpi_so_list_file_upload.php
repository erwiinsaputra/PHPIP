<?php $i=0; foreach ($file_kpi_so as $rows) { $i++; ?>
    ...
    <tr role="row" class="heading">
        ...
        <td >
            <a href="<?php echo base_url('public/files/kpi_so/'.$file_name); ?>" target="blank"><?=$file_name?></a>
        </td>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.list_file_upload_kpi_so').on('click', '.btn_delete', function(e) {
            //param
            ...
            function(){
                    var url    = "<?=site_url($url);?>/delete_file_kpi_so";
