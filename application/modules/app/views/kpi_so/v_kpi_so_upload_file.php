...
<form id="fileupload" action="<?=site_url($url);?>/upload_file_kpi_so" method="POST" enctype="multipart/form-data">

    <!-- HIDDEN FILE -->
	<input type="hidden" name="id" id="id_kpi_so" value="<?=@$id;?>"/>
...
<div class="table-container">
    <table class="table table-striped table-bordered table-hover">            
        ...
        <tbody class="list_file_upload_kpi_so" idnya="<?=@$id?>">
            <?=@$html_list_file_upload_kpi_so;?>
        </tbody>
    </table>
</div>
...
<script type="text/javascript">
    ...
    window.finish_upload = function(){
        window.list_file_upload_kpi_so();
        window.list_file_kpi_so();
    }

    window.list_file_upload_kpi_so = function(){
        var id          = "<?=@$id;?>";
        var param       = {id:id};
        var url         = "<?=site_url($url);?>/list_file_upload_kpi_so";
        Metronic.blockUI({ target: '.list_file_upload_kpi_so',  boxed: true});
        $.post(url, param, function(msg){
            $('.list_file_upload_kpi_so').html(msg);
            Metronic.unblockUI('.list_file_upload_kpi_so');
        });
    }
