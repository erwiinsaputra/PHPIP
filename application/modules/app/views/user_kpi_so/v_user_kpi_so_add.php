    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input name="id_kpi_so" id="id_kpi_so" type="text" class="required form-control" placeholder="Select" data-bvalidator="required"/>
                </div>
            </div>
        </div>
        <br><br>
...
$(document).ready(function () {
    ...
    $("#form_add input[name='nip']").select2({
        ...
        formatSelection: function(item){ 
            ...
            window.cek_user_kpi_so(item.id);
            return item.name; 
        }
    ...
    //select id_kpi_so
    $("#form_add input[name='id_kpi_so']").select2({
        minimumInputLength: -1,
        dropdownAutoWidth : true,
        allowClear:true,
        multiple: true,
    ...
    //cek user_kpi_so sudah ada
    
    
    //cek user_kpi_so
    window.cek_user_kpi_so = function(nip){
        var url = "<?=site_url($url);?>/cek_user_kpi_so";
        var param = {nip:nip};
        $.post(url, param, function(msg){
            if(msg.cek == '1'){
