  ...
  <div class="form-body">
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                <label class="control-label col-md-3" style="font-size:1.1em;">
                    <b>Keterangan</b>
                </label>
                <div class="col-md-8">
                    <textarea style="font-size:1.1em;" readonly="readonly" name="recommendations" class="form-control required" rows="6" data-bvalidator="required" autocomplete="off"><?=@$data->penyebab1;?></textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-3" style="font-size:1.1em;">
                ...
                <div class="col-md-8">
                    <textarea style="font-size:1.1em;" readonly="readonly" name="recommendations" class="form-control required" rows="3" data-bvalidator="required" autocomplete="off"><?=@$data->recommendations;?></textarea>
                </div>
            </div>
            <div class="form-group">
                <h3 style="text-align:center;margin-left: 5em;">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <textarea style="font-size:1.1em;" readonly="readonly" name="recommendations" class="form-control required" rows="3" data-bvalidator="required" autocomplete="off"><?=@$data->quick_win;?></textarea>
                </div>
            </div>
      </div>
  </div>
