...
<form id="fileupload" action="<?=site_url($url);?>/upload_file_sr" method="POST" enctype="multipart/form-data">

    <!-- HIDDEN FILE -->
	<input type="hidden" name="id" id="id_sr" value="<?=@$id;?>"/>
...
<div class="table-container">
    <table class="table table-striped table-bordered table-hover">            
        ...
        <tbody class="list_file_upload_sr" idnya="<?=@$id?>">
            <?=@$html_list_file_upload_sr;?>
        </tbody>
    </table>
</div>
...
<script type="text/javascript">
    ...
    window.list_file_upload_sr = function(){
        var id          = "<?=@$id;?>";
        var param       = {id:id};
        var url         = "<?=site_url($url);?>/list_file_upload_sr";
        Metronic.blockUI({ target: '.list_file_upload_sr',  boxed: true});
        $.post(url, param, function(msg){
            $('.list_file_upload_sr').html(msg);
            Metronic.unblockUI('.list_file_upload_sr');
        });
    }
