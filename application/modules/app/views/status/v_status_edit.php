      ...
      <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                  ...
                  <div class="col-md-8">
                      <input value="<?=@$data->name;?>" name="name" type="text" class="form-control" placeholder="Status" data-bvalidator="required" autocomplete="off">
                  </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-8">
                      <input value="<?=@$data->type;?>" name="type" type="text" class="form-control" placeholder="Type" data-bvalidator="required" autocomplete="off">
                  </div>
              </div>
              <div class="form-group">
