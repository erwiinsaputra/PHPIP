...
$(document).ready(function() {
    ...
    //=============================== FILERING =========================================
        ...
        //select2 biasa
        $(".table_perspective .select2_biasa").select2({
    ...
    //=============================== Action =========================================
        ...
        //load add
        $('.table_perspective').on('click', '.btn_add', function(e) {
            $('#popup_add').modal();
            var id = $(this).attr('id');
        ...
        //load edit
        $('.table_perspective').on('click', '.btn_edit', function(e) {
            $('#popup_edit').modal();
            var id = $(this).attr('id');
        ...
        //btn delete
        $('.table_perspective').on('click', '.btn_delete', function(e) {
            var id = $(this).attr('id');
