<div class="row table_template_excel_ic">
    <div class="col-md-12">
        <div class="portlet light ">
            ...
            <div class="portlet-body">
                ...
                <div class="table-container">
                    ...
                    <table class="table table-striped table-bordered table-hover table-wrap" id="table_template_excel_ic">
                        <thead>
                            ...
                            <tr role="row" class="filter display-hide">
                                ...
                                <td><input readonly="readonly" name="name" tipe="1" a1="text-center" class="form-control form-filter input-md" placeholder="search" type="text" ></td>
...
$(document).ready(function() {
    ...
    //================================= Datatable ==========================================
        //variabel
        var table_name  = "table_template_excel_ic";
        var url         = "<?=site_url($url);?>/table_template_excel_ic";
        var sort        = [-1,0];
        var order       = [];
        //column order
        var header = [];
        ...
        //table init
        table_template_excel_ic.initDefault(url, header, order, sort);
    ...
    //=============================== FILERING =========================================
        ...
        $(".table_template_excel_ic #global_id_bsc").select2({
            minimumResultsForSearch: -1, minimumInputLength: -1, allowClear:true, dropdownAutoWidth : true
        }).on('change', function(event) { 
            $('.btn_search').first().click();
        });
    ...
    //=============================== Action =========================================
        ...
        //load add
        $('.table_template_excel_ic').on('click', '.btn_add', function(e) {
            $('#popup_add').modal();
            var id = $(this).attr('id');
        ...
        //load edit
        $('.table_template_excel_ic').on('click', '.btn_edit', function(e) {
            $('#popup_edit').modal();
            var id = $(this).attr('id');
        ...
        //btn delete
        $('.table_template_excel_ic').on('click', '.btn_delete', function(e) {
            var id = $(this).attr('id');
