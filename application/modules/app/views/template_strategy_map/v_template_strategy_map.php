<div class="row table_template_strategy_map">
    <div class="col-md-12">
        <div class="portlet light ">
            ...
            <div class="portlet-title">
                ...
                <div class="actions">
                    ...
                    <div style="float:left;">
                        ...
                        <div style="float:left;">
                           <select class="form-control global-filter"  name="global_id_periode"  tipe="2" placeholder="Periode">
                                <option value=""></option>
            ...
            <div class="portlet-body">
                ...
                <div class="table-container">
                    ...
                    <table class="table table-striped table-bordered table-hover table-wrap" id="table_template_strategy_map">
                        <thead>
                            ...
                            <tr role="row" class="filter display-hide">
                                ...
                                <td><input readonly="readonly" name="file_name" tipe="1" a1="text-center" class="form-control form-filter input-md" placeholder="search" type="text" ></td>
                                <td><input readonly="readonly" name="name_bsc" tipe="1" a1="text-center" class="form-control form-filter input-md" placeholder="search" type="text" ></td>
                                <td><input readonly="readonly" name="name_periode" tipe="1" a1="text-center" class="form-control form-filter input-md" placeholder="search" type="text" ></td>
...
$(document).ready(function() {
    ...
    //================================= Datatable ==========================================
        //variabel
        var table_name  = "table_template_strategy_map";
        var url         = "<?=site_url($url);?>/table_template_strategy_map";
        var sort        = [-1,0];
        var order       = [];
        //column order
        var header = [];
        ...
        //table init
        table_template_strategy_map.initDefault(url, header, order, sort);
    ...
    //=============================== FILERING =========================================
        //date
        $(".table_template_strategy_map .tanggal").datepicker({
             rtl: Metronic.isRTL(), orientation: "left", autoclose: true, format : 'yyyy-mm-dd',
        });

        //select2 biasa
        $(".table_template_strategy_map .select2_biasa").select2({
            minimumResultsForSearch: -1, minimumInputLength: -1, allowClear:true, dropdownAutoWidth : true,
        });

        //select2 biasa2
        $(".table_template_strategy_map select[name='global_id_periode']").select2({
        ...
        $(".table_template_strategy_map #global_id_bsc").select2({
            minimumResultsForSearch: -1, minimumInputLength: -1, allowClear:true, dropdownAutoWidth : true
        }).on('change', function(event) { 
            $('.btn_search').first().click();
        });
    ...
    //=============================== Action =========================================
        ...
        //load add
        $('.table_template_strategy_map').on('click', '.btn_add', function(e) {
            $('#popup_add').modal();
            var id = $(this).attr('id');
        ...
        //load edit
        $('.table_template_strategy_map').on('click', '.btn_edit', function(e) {
            $('#popup_edit').modal();
            var id = $(this).attr('id');
        ...
        //btn delete
        $('.table_template_strategy_map').on('click', '.btn_delete', function(e) {
            var id = $(this).attr('id');
