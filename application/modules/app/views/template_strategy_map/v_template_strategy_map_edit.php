      ...
      <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                  ...
                  <div class="col-md-8">
                      <input readonly="readonly" value="<?=@$data->name_periode;?>" name="periode" type="text" class="form-control" >
                  </div>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
                  <label class="control-label col-md-3">BSC 
                    <span class="required" aria-required="true">*</span>
                  </label>
                  <div class="col-md-8">
                      <input readonly="readonly" value="<?=@$data->name_bsc;?>" name="periode" type="text" class="form-control" >
                  </div>
              </div>
            </div>
            <div class="col-md-12">
