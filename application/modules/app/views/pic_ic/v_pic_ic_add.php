      ...
      <div class="row">
          <div class="col-md-12">
              <div class="form-group">
                  ...
                  <div class="col-md-8">
                      <input name="posisi" type="text" class="form-control" placeholder="Posisi" data-bvalidator="required" autocomplete="off">
                  </div>
              </div>
              <div class="form-group">
                  ...
                  <div class="col-md-8">
                      <input name="singkatan_posisi" type="text" class="form-control" placeholder="Singkatan Posisi" data-bvalidator="required" autocomplete="off">
                  </div>
              </div>
          </div>
      </div>
