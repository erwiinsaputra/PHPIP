        ...
        <div class="portlet light ">
            ...
            <div class="portlet-body">
                ...
                <div class="table-container">
                    ...
                    <table class="table table-striped table-bordered table-hover table-wrap" id="table_workunit">
                        <thead>
                            ...
                            <tr role="row" class="filter display-hide">
                                ...
                                <td><input name="code" tipe="1" a1="text-center" a2="false" class="form-control form-filter input-md" placeholder="search" type="text" autocomplete="off"></td>
                                <td><input name="name" tipe="1" a1="text-center" class="form-control form-filter input-md" placeholder="search" type="text" ></td>
                                <td><select a1="text-center" class="form-control form-filter select-filter input-md select2_biasa"  name="is_corporate" tipe="2" placeholder="Search" >
                                        <option value=""></option>
...
$(document).ready(function() {
    ...
    //================================= Datatable ==========================================
        //variabel
        var table_name  = "table_workunit";
        var url         = "<?=site_url($url);?>/table_workunit";
        var sort        = [-1,0];
        var order       = [];
        //column order
        var header = [];
        ...
        //table init
        table_workunit.initDefault(url, header, order, sort);
    ...
    //=============================== FILERING =========================================
        //date
        $(".table_workunit .tanggal").datepicker({
             rtl: Metronic.isRTL(), orientation: "left", autoclose: true, format : 'yyyy-mm-dd',
        });

        //select2 biasa
        $(".table_workunit .select2_biasa").select2({
    ...
    //=============================== Action =========================================
        ...
        //load add
        $('.table_workunit').on('click', '.btn_add', function(e) {
            $('#popup_add').modal();
            var id = $(this).attr('id');
        ...
        //load edit
        $('.table_workunit').on('click', '.btn_edit', function(e) {
            $('#popup_edit').modal();
            var id = $(this).attr('id');
        ...
        //btn delete
        $('.table_workunit').on('click', '.btn_delete', function(e) {
            var id = $(this).attr('id');
