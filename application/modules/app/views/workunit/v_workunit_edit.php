      ...
      <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                  ...
                  <div class="col-md-8">
                      <input value="<?=@$data->name;?>" name="name" type="text" class="form-control" placeholder="Workunit" data-bvalidator="required" autocomplete="off">
                  </div>
              </div>
              <div class="form-group">
                  ...
                  <div class="col-md-8">
                        <select name="is_corporate" placeholder="Is Corporate" class="form-control select2_biasa"  data-bvalidator="required" >
                            <option value=""></option>
                            <option <?=($data->is_corporate == 't' ? 'selected' : '') ?> value="t">Corporate</option>
                            <option <?=($data->is_corporate == 'f' ? 'selected' : '') ?> value="f">Non Corporate</option>
                        </select>
                  </div>
              </div>
              <div class="form-group">
