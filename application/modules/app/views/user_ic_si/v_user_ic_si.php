<div class="row table_user_ic_si">
    <div class="col-md-12">
        <div class="portlet light ">
            ...
            <div class="portlet-body">
                ...
                <div class="table-container">
                    ...
                    <table class="table table-striped table-bordered table-hover table-wrap" id="table_user_ic_si">
                        <thead>
                            ...
                            <tr role="row" class="filter display-hide">
                                ...
                                <td><input name="nip" tipe="1" a1="text-left" class="form-control form-filter input-md" placeholder="search" type="text" autocomplete="off"></td>
                                <td><input name="fullname" tipe="1" a1="text-left" class="form-control form-filter input-md" placeholder="search" type="text" autocomplete="off"></td>
                                <td><input name="role_name" tipe="1" a1="text-left" class="form-control form-filter input-md" placeholder="search" type="text" autocomplete="off"></td>
                                <td><input name="name_si" tipe="1" a1="text-left" class="form-control form-filter input-md" placeholder="search" type="text" autocomplete="off"></td>
                                <td><input name="name_position" tipe="1" a1="text-left" class="form-control form-filter input-md" placeholder="search" type="text" autocomplete="off"></td>
...
$(document).ready(function() {
    ...
    //================================= Datatable ==========================================
        //variabel
        var table_name  = "table_user_ic_si";
        var url         = "<?=site_url($url);?>/table_user_ic_si";
        var sort        = [-1,0];
        var order       = [];
        //column order
        var header = [];
        ...
        //table init
        table_user_ic_si.initDefault(url, header, order, sort);
    ...
    //=============================== FILERING =========================================
        //date
        $(".table_user_ic_si .tanggal").datepicker({
             rtl: Metronic.isRTL(), orientation: "left", autoclose: true, format : 'yyyy-mm-dd',
        });

        //select2 biasa
        $(".table_user_ic_si .select2_biasa").select2({
    ...
    //=============================== Action =========================================
        ...
        //load add
        $('.table_user_ic_si').on('click', '.btn_add', function(e) {
            $('#popup_add').modal();
            var id = $(this).attr('id');
        ...
        //load edit
        $('.table_user_ic_si').on('click', '.btn_edit', function(e) {
            $('#popup_edit').modal();
            var id = $(this).attr('id');
        ...
        //btn delete
        $('.table_user_ic_si').on('click', '.btn_delete', function(e) {
            var id = $(this).attr('id');
