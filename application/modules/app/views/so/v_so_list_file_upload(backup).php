...
<form id="fileupload" action="<?=site_url($url);?>/upload_file_so" method="POST" enctype="multipart/form-data">

    <!-- HIDDEN FILE -->
	<input type="hidden" name="id" id="id_so" value="<?=@$id;?>"/>
...
<div class="table-container">
    <table class="table table-striped table-bordered table-hover">            
        ...
        <tbody class="list_file_upload_so" idnya="<?=@$id?>">
            <?=@$html_list_file_upload_so;?>
        </tbody>
    </table>
</div>
...
<script type="text/javascript">
    ...
    window.list_file_upload_so = function(){
        var id          = "<?=@$id;?>";
        var param       = {id:id};
        var url         = "<?=site_url($url);?>/list_file_upload_so";
        Metronic.blockUI({ target: '.list_file_upload_so',  boxed: true});
        $.post(url, param, function(msg){
            $('.list_file_upload_so').html(msg);
            Metronic.unblockUI('.list_file_upload_so');
        });
    }
