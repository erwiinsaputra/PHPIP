...
<form id="fileupload" action="<?=site_url($url);?>/upload_file_request_ic" method="POST" enctype="multipart/form-data">

    <!-- HIDDEN FILE -->
	<input type="hidden" name="id" id="id_request_ic" value="<?=@$id;?>"/>
...
<div class="table-container">
    <table class="table table-striped table-bordered table-hover">            
        ...
        <tbody class="list_file_upload_request_ic" idnya="<?=@$id?>">
            <?=@$html_list_file_upload_request_ic;?>
        </tbody>
    </table>
</div>
...
<script type="text/javascript">
    ...
    window.finish_upload = function(){
        window.list_file_upload_request_ic();
        window.list_file_request_ic();
    }

    window.list_file_upload_request_ic = function(){
        var id          = "<?=@$id;?>";
        var param       = {id:id};
        var url         = "<?=site_url($url);?>/list_file_upload_request_ic";
        Metronic.blockUI({ target: '.list_file_upload_request_ic',  boxed: true});
        $.post(url, param, function(msg){
            $('.list_file_upload_request_ic').html(msg);
            Metronic.unblockUI('.list_file_upload_request_ic');
        });
    }
