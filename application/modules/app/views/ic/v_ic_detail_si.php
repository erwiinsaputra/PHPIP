                    ...
                    <div class="">
                        <table class="table table-bordered" id="table_direct_so">
                            ...
                            <tbody id="load_add_direct">
                                ...
                                <?php } ?>
                                <?php if(count(@$direct) == 0){?>
                                <tr>
                                    <td style="text-align:center;" colspan="2">Empty Data</td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                    ...
                    <div class="">
                        <table class="table table-bordered" id="table_indirect_so">
                            ...
                            <tbody id="load_add_indirect">
                                ...
                                <tr>
                                    <td style="text-align:center;"><?='('.$row->code_so.') '.$row->name_so?></td>
                                    <td style="text-align:center;"><?='('.$row->code_kpi_so.') '.$row->name_kpi_so?></td>
                                </tr>
                                <?php } ?>
                                <?php if(count(@$indirect) == 0){?>
                                <tr>
                                    <td style="text-align:center;" colspan="2">Empty Data</td>
                                </tr>
                                <?php } ?>
