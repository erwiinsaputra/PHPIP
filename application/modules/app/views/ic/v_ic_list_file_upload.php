<?php $i=0; foreach ($file_ic as $rows) { $i++; ?>
    ...
    <tr role="row" class="heading">
        ...
        <td >
            <a href="<?php echo base_url('public/files/ic/'.$file_name); ?>" target="blank"><?=$file_name?></a>
        </td>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.list_file_upload_ic').on('click', '.btn_delete', function(e) {
            //param
            ...
            function(){
                    var url    = "<?=site_url($url);?>/delete_file_ic";
