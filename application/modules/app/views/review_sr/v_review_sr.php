                    ...
                    <table class="table table-striped table-bordered table-hover table-wrap" id="table_review_sr">
                        <thead>
                            ...
                            <tr role="row" class="filter display-hide">
                                ...
                                <td><input name="ukuran" tipe="1" a1="text-center" a2="false"  class="form-control form-filter input-md" placeholder="search" type="text" ></td>
                                <td><input name="target" tipe="1" a1="text-center" a2="false"  class="form-control form-filter input-md" placeholder="search" type="text" ></td>
                                ...
                                <td><select name="name_status_sr" tipe="2" a2="false" a1="text-center" class="form-control form-filter select-filter input-md select2_biasa"   placeholder="Search" >
                                        <option value=""></option>
...
$(document).ready(function() {
    ...
    //=============================== FILERING =========================================
        ...
        $(".table_review_sr #global_id_bsc").select2({
            ...
            $('.table_review_sr #global_id_strategic_theme').val('');
            $(".table_review_sr #global_id_strategic_theme").change();
        });

        //select2 global_id_bsc
        $(".table_review_sr #global_id_strategic_theme").select2({
            minimumResultsForSearch: -1, minimumInputLength: -1, allowClear:true, dropdownAutoWidth : true
        }).on('change', function(event) { 
            $('.table_review_sr .filter-submit').first().click();
        });
    ...
    //=============================== Action =========================================
        ...
        //load add
        $('.table_review_sr').on('click', '.btn_add_progress', function(e) {
            $('#popup_add').modal();
            var id = $(this).attr('id');
        ...
        //load edit
        $('.table_review_sr').on('click', '.btn_edit', function(e) {
            $('#popup_edit').modal();
            var id = $(this).attr('id');
            var type = 'edit';
        ...
        //load view
        $('.table_review_sr').on('click', '.btn_view', function(e) {
            $('#popup_view').modal();
            var id = $(this).attr('id');
            var type = 'view';
            var url = "<?=site_url($url);?>/load_edit";
        ...
        //load copy
        $('.table_review_sr').on('click', '.btn_copy', function(e) {
            $('#popup_copy').modal();
            var id = $(this).attr('id');
        ...
        //btn delete
        $('.table_review_sr').on('click', '.btn_delete', function(e) {
            var id = $(this).attr('id');
