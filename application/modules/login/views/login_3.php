            ...
            <div class="container">
                ...
                <div class="row txt_title" style="text-align: center;margin-top: 25vh; z-index: 1px;">
                    ...
                    <div class="col-md-12" style="padding: 10px;font-style: italic;">
                        <p id="subtitle" class="wow animated fadeInDown">Strategic Initiative Management Office</p>
                    </div>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#select_user").select2({
                  ...
                  ajax:{
                      url: "<?=site_url();?>/login/index/select_user",
                      dataType: 'json',
                      quietMillis: 250,
                      cache: true,
                ...
                formatSelection: function (item){
                    ...
                    if (item.name !== undefined) {
                        var hasil = "<option value='"+item.id+"'>"+item.name+"</option>";
                    }
                    $('#username').val(item.nopeg);
                    return hasil;
                }
            });
