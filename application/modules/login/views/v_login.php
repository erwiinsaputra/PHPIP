...
<body class="green-color dark-theme">
    <header id="header" style="height:650px; min-height:650px;">
        <div class="content">
            <div class="container">
                <div class="row">
                    <div class="background">
                        ...
                        <!-- </video> -->
                        <div style="background-image: linear-gradient(#0481a2, lightblue); position:relative; min-width:100%;min-height:100%; width:100%;height:100%;" >
                            <img style="margin-left:auto; margin-right:auto; position:relative; display:block; min-width:1250px;min-height:650px; width:1250px; height:650px; top:0%; left:0% !important;" src="<?php echo base_url('public/assets/login/img/banner_1.png');?>">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                            ...
                            <form class="login-form" action="javascript:;" method="post">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-users btn_cek"></i></span>
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-key btn_select_user"></i></span>
                                        <input id="password" name="password" class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" style="border-left: 1px solid black;" required/>
                                    </div>
                                </div>
                                <div class="form-group" style="margin-top: -5px; margin-bottom: 10px; display:none;" id="input_select_user">
                                    <div class="input-group">
                                        ...
                                        <input id="cek" class="form-control" type="hidden" value="0"/>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-8 social" id="login_button" >
                        <a href="javascript:;" class="wow animated bounceIn icon" data-wow-delay=".5s" style="display: inline-block;background:black;"><i class="fa fa-user-circle-o"></i></a> 
    ...
    <section class="bg bg-team" style="padding:4em !important; background-image: linear-gradient(lightblue, yellow);">
        <div class="container ">
    ...
    <section class="short" style="background-image: linear-gradient(yellow, lightblue);">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 contact" >
                   <p><strong>CONNECT WITH US</strong></p>
                    <div style="font-size:1em !important;">
                        <a traget="_blank" href="https://www.indonesiapower.co.id" style="color:yellow;">www.indonesiapower.co.id</a>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#select_user").select2({
                ...
                multiple: true,
                ajax: {
                url: "<?php echo site_url('login/select_user')?>",
