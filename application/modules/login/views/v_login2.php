            ...
            <div class="container">
                <div class="row">
                    <div class="background center">
                        ...
                        <!-- </video> -->
                        <img style="position: relative; min-width:90%; min-height:77%;width:90%; height:77%; display: block; margin-left: auto; margin-right: auto; top:0%; left:0% !important;" 
                                src="<?php echo base_url('public/assets/login/img/banner_1.png');?>">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-4">
                        <!-- <img style="margin-top:3em;height: 50px;" src="<?php echo base_url('public/assets/login/img/logo.png');?>"> -->
                    </div>
